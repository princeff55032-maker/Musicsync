...
Musicsync is a high-precision web audio player for multi-device synchronized playback. Turborepo monorepo with three packages:
...
- **PM2**: Config in `pm2.config.js`. Process name: `musicsync-server`.
